...
class frame_set:
    ...
    def __init__(self, a_xml_string, a_subcorpus=None, lang_id=None):
        ...
        #here the chinese is actually not utf-8
        try:
            a_frameset_tree = ElementTree.fromstring(a_xml_string.encode('utf-8'))
        except SyntaxError:
            raise
...
class proposition(object):
    ...
    @property
    def enc_prop(self):
        #here for chinese so unicode
        return " ".join(unicode(x) for x in self.get_enc_prop_list())
